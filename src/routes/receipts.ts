...
export function createReceiptsRouter(receiptRegistry: ReceiptRegistry): Router {
  ...
  receiptsRouter.get("/wallet/:wallet", (req, res) => {
    ...
    const receipts = receiptRegistry.listReceipts().filter((receipt: any) => {
